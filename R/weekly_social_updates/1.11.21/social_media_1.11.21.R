...
ggsave("cmc_active_1.11.20.svg", plt3, width = 14, height = 10)
ggsave("cmc_active_1.11.20.png", plt3, width = 14, height = 10)
...
ggsave("cmc_cumulative_1.11.20.svg", plt4, width = 14, height = 10)
ggsave("cmc_cumulative_1.11.20.png", plt4, width = 14, height = 10)
